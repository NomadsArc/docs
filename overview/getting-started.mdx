---
title: "Getting Started with Slice 'n Save: Plans & Concepts"
...
| Term | Description |
|---|---|
| **Slice 'n Save** | A no-code Shopify app that lets you apply automatic discounts at checkout using flexible conditions — no developer required. |
